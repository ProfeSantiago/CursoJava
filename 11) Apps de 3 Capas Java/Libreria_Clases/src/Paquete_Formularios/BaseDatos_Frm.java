...
import Paquete_Clases.Bases_Datos;
import java.sql.*;

public class BaseDatos_Frm extends javax.swing.JFrame {
//-----------------------------------
//Declaracion de Variables Globales
Bases_Datos BDatos = new Bases_Datos();
...
public void Consulta(){
    BDatos.Consultar("Personas");    
    try {
        while (BDatos.Registro.next()) {
            Cedula = BDatos.Registro.getString("Cedula");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaseDatos_Frm().setVisible(true);
            }
        });
    }
