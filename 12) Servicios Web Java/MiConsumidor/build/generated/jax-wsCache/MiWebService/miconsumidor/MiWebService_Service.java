 ...
 * 
 */
@WebServiceClient(name = "MiWebService", targetNamespace = "http://Paquete/", wsdlLocation = "http://localhost:8080/ServicioWeb_Netbeans/MiWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MIWEBSERVICE_QNAME = new QName("http://Paquete/", "MiWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServicioWeb_Netbeans/MiWebService?wsdl");
    ...
    public MiWebService getMiWebServicePort() {
        return super.getPort(new QName("http://Paquete/", "MiWebServicePort"), MiWebService.class);
    }
    ...
    public MiWebService getMiWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Paquete/", "MiWebServicePort"), MiWebService.class, features);
    }
