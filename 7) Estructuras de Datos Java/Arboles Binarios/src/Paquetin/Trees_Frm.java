...
public class Trees_Frm extends javax.swing.JFrame {
    ...
    Arbol Palo = new Arbol();
    Arbol Arbusto =  new Arbol();
    String Texto = "";

    public void EnOrden(Arbol Raiz){
        if (Raiz == null) return;
        EnOrden(Raiz.izq);
        Lista_Consulta.add(Raiz.Texto);
        EnOrden(Raiz.der);
    }
    ...
    private void initComponents() {
        ...
        Texto_txt.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                Texto_txtKeyReleased(evt);
            }
        });

        jLabel3.setText("Nombres en el Árbol:");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(Texto_txt, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void Texto_txtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Texto_txtKeyReleased

}//GEN-LAST:event_Texto_txtKeyReleased
    ...
    private void Inserta_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Inserta_BtnActionPerformed
       Texto = Texto_txt.getText();
       Palo = Palo.Inserta(Palo, Texto);
       Lista_Original.add(Texto_txt.getText());
       Texto_txt.setText("");
