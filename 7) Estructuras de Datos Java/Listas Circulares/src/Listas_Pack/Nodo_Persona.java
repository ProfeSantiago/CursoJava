...
// xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    Nuevo_Nodo.Sgte = Nuevo_Nodo;   //Ojo aquí es donde lista se vuelve "Circular"
...
/* xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx 
    La condición del While se cambió porque la lista es circular y ahora dá   
    vueltas eternamente y no hay ningún null que lo pare. Antes lucía así:
                                        while (Actual != null && resultado != 0)
  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx */    
    while (Actual != Lista && resultado < 0){ 
