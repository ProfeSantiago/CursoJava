/*************************************************************************
 *Listas_Frm.java - Primer Ejemplo de Listas Simples
...
public class Listas_Frm extends javax.swing.JFrame {
    //--------------------------------------------
    // Declaracion de Variables
    //--------------------------------------------
    Nodo_Persona Lista;
    Nodo_Persona Puntero_Actual; //Nuevo: Para Recorrido
    Persona Personilla = new Persona(); //Constructor #2
    ...
    private void Busca_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Busca_BtnActionPerformed
      if (!Nombre_txt.getText().equals("")){
          ...
          JOptionPane.showMessageDialog(rootPane, "Debe digitar un nombre para buscar");
      }
...
private void Next_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_BtnActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Listas_Frm().setVisible(true);
            }
        });
    }
