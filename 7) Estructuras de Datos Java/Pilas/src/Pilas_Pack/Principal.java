...
public class Principal extends javax.swing.JFrame {
    ...
    public void Abrir_Archivo(){
        int contador = 0;
        Archivo.Abrir_Archivo("Pilas.txt");       
        while (contador < 4){             
            ...
            Pila = Pila.Push(Pila, Personilla);           
            contador++;
        }//Fin While 
    ...
    public void Guarda_Archivo(){
        Nodo_Persona Actual; 
        Archivo.Crear_Archivo("Pilas.txt");
        Actual = Pila;        
        while (Actual != null){            
    ...
    private void Push_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Push_BtnActionPerformed
        Personilla = new Persona(Cedula_txt.getText(),Nombre_txt.getText(),Telefono_txt.getText());
        Pila = Pila.Push(Pila, Personilla);
        Puntero_Actual = Pila; //Nuevo: Para Recorrido
        Llena_Lista();
        Limpiador();
